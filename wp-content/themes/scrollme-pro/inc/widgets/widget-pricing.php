    ...
    private function widget_fields() {
        $fields = array(
            ...
            'pricing_plan_sub_text' => array(
                ...
                'scrollme_widgets_title' => __('Sub Text', 'scrollme-pro'),
                'scrollme_widgets_field_type' => 'text',
            ),
            ...
            'pricing_price_decimal' => array(
                ...
                'scrollme_widgets_title' => __('Decimal Value', 'scrollme-pro'),
                'scrollme_widgets_field_type' => 'text',
            ),
            ...
            'pricing_feature1_font_a' => array(
                ...
                'scrollme_widgets_title' => __('Feature 1 Font Awesome', 'scrollme-pro'),
                'scrollme_widgets_field_type' => 'text',
            ),
            ...
            'pricing_feature2_font_a' => array(
                ...
                'scrollme_widgets_title' => __('Feature 2 Font Awesome', 'scrollme-pro'),
                'scrollme_widgets_field_type' => 'text',
            ),
            ...
            'pricing_feature3_font_a' => array(
                ...
                'scrollme_widgets_title' => __('Feature 3 Font Awesome', 'scrollme-pro'),
                'scrollme_widgets_field_type' => 'text',
            ),
            ...
            'pricing_feature4_font_a' => array(
                ...
                'scrollme_widgets_title' => __('Feature 4 Font Awesome', 'scrollme-pro'),
                'scrollme_widgets_field_type' => 'text',
            ),
            ...
            'pricing_feature5_font_a' => array(
                ...
                'scrollme_widgets_title' => __('Feature 5 Font Awesome', 'scrollme-pro'),
                'scrollme_widgets_field_type' => 'text',
            ),
            ...
            'pricing_feature6_font_a' => array(
                ...
                'scrollme_widgets_title' => __('Feature 6 Font Awesome', 'scrollme-pro'),
                'scrollme_widgets_field_type' => 'text',
            ),
            ...
            'pricing_featured' => array(
                ...
                'scrollme_widgets_title' => __('Featured', 'scrollme-pro'),
        ...
        <div class="wow fadeInUp ap-pricing-table <?php if( !empty( $pricing_featured ) ) { echo 'feat-tble';} ?>">
            <div class="ap-pricing-head">
                <?php if (!empty($pricing_plan)): ?>
                    <h2>
                        <?php echo $pricing_plan; ?><?php echo $pricing_featured; ?>
                    </h2>
                <?php endif; ?>
            ...
            <div class="ap-price-box">
                <?php if (!empty($pricing_price)): ?>
                    <div class="ap-pricing-plan">
                        <?php if( !empty( $pricing_price_currency )) { echo  '<span class="currency">'.$pricing_price_currency.'</span>'; } ?><?php echo $pricing_price; ?>
                        <?php if( !empty( $pricing_price_decimal ) ) { echo  '<span class="dec-value">'.$pricing_price_decimal.'</span>'; }?>
                    </div>
            ...
            <div class="ap-pricing-features">
                <ul class="ap-pricing-features-inner">
                    <?php if (!empty($pricing_feature1)): ?>
                        <li><span><?php if( !empty( $pricing_feature1_a ) ) { echo '<i class="'.$pricing_feature1_a.'"></i>';}?></span><?php echo $pricing_feature1; ?></li>
                    <?php endif; ?>
                    <?php if (!empty($pricing_feature2)): ?>
                        <li><span><?php if( !empty( $pricing_feature2_a ) ) { echo '<i class="'.$pricing_feature2_a.'"></i>';}?></span><?php echo $pricing_feature2; ?></li>
                    <?php endif; ?>
                    <?php if (!empty($pricing_feature3)): ?>
                        <li><span><?php if( !empty( $pricing_feature3_a ) ) { echo '<i class="'.$pricing_feature3_a.'"></i>';}?></span><?php echo $pricing_feature3; ?></li>
                    <?php endif; ?>
                    <?php if (!empty($pricing_feature4)): ?>
                        <li><span><?php if( !empty( $pricing_feature4_a ) ) { echo '<i class="'.$pricing_feature4_a.'"></i>';}?></span><?php echo $pricing_feature4; ?></li>
                    <?php endif; ?>
                    <?php if (!empty($pricing_feature5)): ?>
                        <li><span><?php if( !empty( $pricing_feature5_a ) ) { echo '<i class="'.$pricing_feature5_a.'"></i>';}?></span><?php echo $pricing_feature5; ?></li>
                    <?php endif; ?>
                    <?php if (!empty($pricing_feature6)): ?>
                        <li><span><?php if( !empty( $pricing_feature6_a ) ) { echo '<i class="'.$pricing_feature6_a.'"></i>';}?></span><?php echo $pricing_feature6; ?></li>
                    <?php endif; ?>
